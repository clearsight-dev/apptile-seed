...
import { View, Text, TextInput, TouchableOpacity, ActivityIndicator, Alert, Image, StatusBar, KeyboardAvoidingView, ScrollView, Platform } from 'react-native';
  ...
  if (checkingUser) {
    return (
      <View
        ...
        style={[styles.loadingContainer, { flex: 1 }]}
      >
