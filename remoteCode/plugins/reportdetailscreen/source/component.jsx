...
export function ReactComponent({ model }) {
  ...
  if (gettingLocation) {
    return (
      <View nativeID={'rootElement-' + id} style={[styles.container, { flex: 1, backgroundColor, justifyContent: 'center', alignItems: 'center' }]}>
  ...
  return (
    <View nativeID={'rootElement-' + id} style={[styles.container, { flex: 1, backgroundColor }]}>
      {/* Header */}
      ...
      >
        ...
        <TouchableOpacity
          style={{
            backgroundColor: detectedSeverity ? primaryColor : '#cccccc',
            paddingVertical: 16,
            borderRadius: 12,
            alignItems: 'center',
            marginBottom: 20,
            opacity: detectedSeverity ? 1 : 0.5,
          }}
          onPress={handleSubmit}
          disabled={loading || !detectedSeverity}
        ...
        >
          {loading ? (
            ...
            <Text style={{ color: '#ffffff', fontSize: 16, fontWeight: '600' }}>
              {detectedSeverity ? 'Submit' : 'Analyzing...'}
            </Text>
          )}
        </TouchableOpacity>
        </ScrollView>
