...
export class ZegoExpressEngineImpl {
    ...
    static startPip(num) {
      console.log("Starting pip. Argument: ", num);
      return ZegoExpressNativeModule.startPip(1);
    }
    static cleanupPip(num) {
      console.log("Stopping pip. Argument: ", num);
      return ZegoExpressNativeModule.cleanupPip(1);
    }
    static getVersion() {
