...
async function main() {
  ...
  if (apptileConfig.android && (apptileConfig.android.build_number || apptileConfig.android.version)) {
    const versionPropsPath = path.resolve(androidFolderLocation, 'app/version.properties');
    ...
    if (apptileConfig.android.build_number) {
      console.log(chalk.green(`Setting app version code to ${apptileConfig.android.build_number}`));
    ...
    if (apptileConfig.android.version) {
      console.log(chalk.green(`Setting app version name to ${apptileConfig.android.version}`));
